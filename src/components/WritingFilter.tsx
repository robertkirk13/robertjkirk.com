...
export default function WritingFilter({
	...
	const otherPosts = showLatestFeatured
					...
					<>
						...
						{latestPost && showLatestFeatured && (
							<a
								...
								className="block group bg-gray-50 dark:bg-black rounded-2xl p-4 md:p-5 border border-gray-200 dark:border-neutral-900 hover:border-blue-500 dark:hover:border-blue-500 transition-all"
							>
						...
						{otherPosts.map((post) => (
							<a
								...
								className="block group bg-gray-50 dark:bg-black rounded-2xl p-4 border border-gray-200 dark:border-neutral-900 hover:border-blue-500 dark:hover:border-blue-500 transition-all"
							>
