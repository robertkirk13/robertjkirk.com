---
title: "Myths of Modern Manufacturing"
date: "2025-05-15"
...
<div class="flex flex-col gap-4 bg-neutral-100 dark:bg-neutral-900/70  p-8 rounded-lg">
    ...
    <span class="hover:text-blue-500 transition-colors duration-300">3. Simplify or optimize the design.</span> 
