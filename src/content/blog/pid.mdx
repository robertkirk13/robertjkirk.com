...
subtitle: "An interactive exploration of the feedback loops that quietly run the world"
date: "2025-11-30"
...
recommendedNext: "autonomous-boat-week-1"
---
...
You've probably benefited from multiple PID controllers today without even realizing it. They're in your car's cruise control, your home thermostat, and the robotic arm that assembled your phone. PID controllers are everywhere because they provide an elegantly simple solution to a common problem: **how do you get a dynamic system to go where you want, and stay there despite disturbances?**
